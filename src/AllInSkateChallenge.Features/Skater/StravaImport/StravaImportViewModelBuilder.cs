...
public class StravaImportViewModelBuilder : PageViewModelBuilder<StravaImportViewModel>, IStravaImportViewModelBuilder
{
    ...
    public override async Task<PageViewModel<StravaImportViewModel>> Build()
    {
        ...
        model.IntroductoryText = "Please note that the only Strava activity types which are eligible for the Roller Girl Gang Virtual Skate Marathon are Inline Skating, Ice Skating and Skateboarding.";
