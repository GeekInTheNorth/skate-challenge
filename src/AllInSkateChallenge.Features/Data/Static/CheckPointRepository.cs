        ...
        public List<CheckPointModel> Get()
        {
            return new List<CheckPointModel>
            {
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.59544M,
                    Latitude = 53.80158M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/armley-park-1.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.57214M,
                    Latitude = 53.77781M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/elland-road-1.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.53833M,
                    Latitude = 53.77472M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/middleton-railway-1.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.49093M,
                    Latitude = 53.73986M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/carlton-rubarb-triangle-farm-shop-1.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.45505M,
                    Latitude = 53.7901M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/temple_newsam_park_2.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.53926M,
                    Latitude = 53.79862M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/kirkgate-market-2.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Description = "We have arrived at the Yorkshire Cricket ground, located in student hotspot Headingley.  The ground is the fifth largest cricket ground in the UK and hosts international cricket matches.",
                    Longitude = -1.58173M,
                    Latitude = 53.81774M,
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.60677M,
                    Latitude = 53.82076M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/kirkstall-abbey-2.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.67085M,
                    Latitude = 53.81422M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/sunnybank-mill-1.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.58868M,
                    Latitude = 53.84302M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/brownlee-centre-1.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.58551M,
                    Latitude = 53.87128M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/golden-acre-park-4.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.54489M,
                    Latitude = 53.87017M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/eccup-reservoir-1.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.53767M,
                    Latitude = 53.88666M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/emmerdale-1.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.52731M,
                    Latitude = 53.89689M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/harewood-house-1.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.67177M,
                    Latitude = 53.89492M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/otley-chevin-1.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.67441M,
                    Latitude = 53.86877M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/yeadon-tarn-1.jpg"),
                ...
                new CheckPointModel
                {
                    ...
                    Longitude = -1.66153M,
                    Latitude = 53.86794M,
                    Image = absoluteUrlHelper.Get("/rggeventone/checkpoint-photo/leeds-bradford-airport-1.jpg"),
